...
public class Kick
{
    ...
    triggers_subsafe_uncolloquial = {"boot", "punt", "calcitrate"},
	
	triggers_subsafe_colloquial = {"kick"},
	...
	public Kick(Scenario scenario, Player player)
	{
		...
		// damage rolling //
		int damage_pure = player.roll_damage_pure_unarmed() + Random.integer_from(1, 6), damage;
